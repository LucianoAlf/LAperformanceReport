...
-- Função simplificada para gerar dados do Relatório Gerencial (sem motivos de evasão complexos)
...
BEGIN
  ...
  -- Motivos de evasão (usando view existente)

-- Republica os comparativos a partir dos fechamentos mensais canonicos.
...
alter function public.get_relatorio_gerencial_canonico_v1(uuid, integer, integer)
  rename to get_relatorio_gerencial_canonico_comparativos_final_base_v1;
...
begin
  v_base := public.get_relatorio_gerencial_canonico_comparativos_final_base_v1(
...
revoke all on function public.get_relatorio_gerencial_canonico_comparativos_final_base_v1(uuid, integer, integer)
  from public, anon, authenticated, service_role;

-- ============================================================================
-- P08A-fix3 - Bolsista em KPI operacional usa tipo_matricula_id canonico
-- Projeto alvo: ouqwbbermlzqqvtqwlul
--
-- Regra de negocio LA Report:
-- - tipo_aluno legado pode estar contaminado e nao deve classificar bolsista
--   para MRR/KPI operacional.
-- - Bolsista integral/parcial entra pelo tipo_matricula_id canonico.
-- - Banda/projeto segue contando somente quando status = ativo.
-- ============================================================================
...
IS 'KPIs vivos para relatorio administrativo: aluno regular trancado permanece na carteira; banda/projeto conta apenas ativo; bolsista usa tipo_matricula_id canonico.';

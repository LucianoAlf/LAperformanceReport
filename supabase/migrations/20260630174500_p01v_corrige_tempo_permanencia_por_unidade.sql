-- ============================================================================
-- P0.1V - Corrige selecao de tempo de permanencia por unidade
-- Projeto alvo: ouqwbbermlzqqvtqwlul
--
-- Corrige a P0.1U: get_tempo_permanencia(p_unidade_id) retorna linhas das tres
-- unidades, com zero nas demais. A wrapper precisa filtrar explicitamente a
-- unidade antes do LIMIT 1.
--
-- Nao faz:
...
IS 'P0.1V wrapper: preserva financeiro vivo, alinha contadores estruturais com get_kpis_alunos_admin_operacional e injeta tempo/LTV filtrando get_tempo_permanencia por unidade.';

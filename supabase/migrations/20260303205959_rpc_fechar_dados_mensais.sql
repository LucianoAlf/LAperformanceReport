...
DECLARE
  ...
  v_faturamento_estimado NUMERIC;
BEGIN
  ...
  LOOP
    ...
    -- Lógica: matriculou antes do fim do mês E (está ativo OU saiu depois do fim do mês)
    ...
    -- Faturamento estimado (ticket_medio * alunos_pagantes)
    v_faturamento_estimado := ROUND(v_ticket_medio * v_alunos_pagantes, 2);
    ...
    INSERT INTO dados_mensais (
      ...
      v_ticket_medio, v_faturamento_estimado
    )

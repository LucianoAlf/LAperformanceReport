...
BEGIN
  ...
  -- Registra movimentação saida_transferencia na origem
  INSERT INTO loja_movimentacoes_estoque
    (produto_id, variacao_id, unidade_id, tipo, quantidade, motivo, via_audit)
  VALUES
    (p_produto_id, p_variacao_id, p_unidade_origem,
     'saida_transferencia', p_quantidade,
     p_motivo || ' | transferência para unidade ' || p_unidade_destino::TEXT,
     p_via_audit);

  -- Registra movimentação entrada_transferencia no destino
  INSERT INTO loja_movimentacoes_estoque
    (produto_id, variacao_id, unidade_id, tipo, quantidade, motivo, via_audit)
  VALUES
    (p_produto_id, p_variacao_id, p_unidade_destino,
     'entrada_transferencia', p_quantidade,
     p_motivo || ' | transferência de unidade ' || p_unidade_origem::TEXT,
     p_via_audit);

...
-- Corrigir função get_dados_relatorio_gerencial - fix aggregate nested error
...
BEGIN
  ...
  -- Cursos mais procurados (usando subquery para evitar nested aggregate)
  ...
  -- Canais com maior conversão (usando subquery)

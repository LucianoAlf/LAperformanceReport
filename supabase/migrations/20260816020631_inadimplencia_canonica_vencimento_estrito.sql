-- A parcela so entra em atraso depois do dia do vencimento.
-- Reaplica integralmente a definicao canonica anterior para manter a migration
-- deterministica e evitar contar vencimentos do proprio dia como inadimplencia.

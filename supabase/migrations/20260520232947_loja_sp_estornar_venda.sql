...
BEGIN
  ...
  LOOP
    ...
    -- Movimentacao de estorno
    INSERT INTO loja_movimentacoes (
  ...
  -- Comissao do professor indicador (se houver)
  IF v_venda.professor_indicador_id IS NOT NULL AND v_total_venda > 0 THEN
    -- Le percentual de loja_configuracoes (chave 'comissao_professor_pct'), senao usa 5%
    ...
    IF v_comissao > 0 THEN
      ...
      -- Registra movimentacao de debito

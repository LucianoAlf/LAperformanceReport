...
-- Recriar view vw_kpis_gestao_mensal com fontes unificadas:
-- 1. Alunos ativos: inclui 'trancado' além de 'ativo'
-- 2. Matrículas: tabela 'alunos' (data_matricula) em vez de 'leads' (status convertido)
...
SELECT 
    ...
    -- Matrículas: agora da tabela alunos (data_matricula)
    (COALESCE(mm.novas_matriculas, 0))::integer AS novas_matriculas,
    -- Evasões: agora da tabela evasoes_v2 (data_evasao)

...
-- RPC da agenda passa a contar só FONTE FORTE (professor_la_teacher, fabio_audio,
-- manual, professor_whatsapp). Cliente não muda de lógica. Revisado/aprovado pelo Alfredo.

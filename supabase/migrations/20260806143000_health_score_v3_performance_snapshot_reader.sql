...
-- O navegador consome exclusivamente a ultima fotografia materializada.
-- Esta funcao nao recalcula nem materializa o Health Score V3.
...
comment on function public.get_health_score_professor_v3_performance_snapshot_v1(
  date, uuid, text
) is 'Leitor direto da ultima fotografia V3; nunca recalcula o score no request.';

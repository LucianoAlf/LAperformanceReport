-- Health Score Professor V3 - permanencia historica acumulada.
-- Corrige a primeira versao, que recortava somente encerramentos do trimestre.
...
select
  ...
  'health-score-professor-v3-permanencia-2'::text as regra_versao,
  case
...
comment on function public.get_professor_permanencia_v3_sombra(date, uuid) is
  'V3 sombra: permanencia acumulada dos vinculos encerrados ate a competencia; bloqueia publicacao quando o inicio historico nao e completo.';

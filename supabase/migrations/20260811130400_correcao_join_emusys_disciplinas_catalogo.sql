...
--
-- Sintoma: "permission denied for table emusys_disciplinas_catalogo" para
-- authenticated ao carregar a Agenda.
--
-- Correcao: mesma cirurgia da 20260803170725 — replace no corpo deployado,
-- trocando 'left join emusys_disciplinas_catalogo dc' por
-- 'left join vw_disciplinas_modalidade dc'. A view ja existe e ja tem grant
-- SELECT para authenticated.
--
-- NAO recria a funcao com drop+create (que derrubaria os grants EXECUTE
-- recem-restaurados pela migration 20260811130300).

-- 2026-08-11 — get_agenda_dia v2: campos da chamada (Fase 2)
-- Spec: docs/superpowers/plans/2026-08-11-chamada-agenda-motor-presenca.md
--
-- Mudanca de assinatura (novas colunas) exige DROP antes do CREATE.
-- Aditivo para o frontend: todas as colunas antigas mantidas, na mesma ordem.
--
-- Por aula: aula_ids (linhas do slot), cancelada_motivo, cancelada_origem.
-- Por aluno: aula_emusys_id (a linha DELE, para a chamada), respondido_por,
-- emusys_presenca_bruta (badge de conflito), justificada_motivo/evidencia,
-- reposicoes_pendentes (saldo de creditos).

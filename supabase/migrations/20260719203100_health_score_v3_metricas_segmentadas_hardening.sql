...
-- Convergencia funcional da Task 5. A ordem inversa respeita as dependencias
-- e permite substituir a assinatura intermediaria da RPC detalhada.
drop function if exists public.materializar_health_score_professor_v3_periodo(
  date,
  text,
  uuid,
  integer
);
drop function if exists public.materializar_health_score_professor_v3_periodo_impl(
  date,
  text,
  uuid,
  integer
);
drop function if exists public.get_health_score_professor_v3_metricas_periodo(
  date,
  uuid,
  text
);
...
-- Fim da convergencia funcional da Task 5.

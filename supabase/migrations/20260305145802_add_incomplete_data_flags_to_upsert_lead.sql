...
DROP FUNCTION IF EXISTS upsert_lead(text,text,text,uuid,text,text,integer,text,boolean);
...
BEGIN
  ...
  IF p_arquivar AND v_lead_id IS NOT NULL THEN
    ...
    VALUES (p_nome, v_lead_id, p_unidade_id::text, p_source_type, v_action, v_detalhes, NOW());

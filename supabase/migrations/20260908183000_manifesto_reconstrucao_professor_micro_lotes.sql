-- Mesmo com uma particao logica por chamada, inserir milhares de linhas com
-- tres indices e chaves estrangeiras podia ultrapassar os 8 s do PostgREST
-- sob pressao acumulada. O manifesto agora avanca em micro-lotes retomaveis.
-- A Edge repete a RPC ate `concluido`; uma falha nao perde o progresso anterior.
...
comment on function public.preparar_manifesto_reconstrucao_professor_v2(
  ...
  'Prepara uma particao do manifesto em micro-lotes retomaveis de 500 linhas, abaixo do timeout do PostgREST.';

-- Vinculo de roster pode ter aluno_id NULL (matricula sem aluno local).
-- A funcao do dia descartava isso implicitamente pelo join com alunos;
-- aqui o descarte precisa ser explicito, senao o mensal exibe linha sem nome.

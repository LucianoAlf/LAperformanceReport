...
COMMENT ON VIEW vw_aluno_sucesso_lista IS 'Lista de alunos para o modulo Sucesso do Aluno. percentual_presenca calculado ao vivo via vw_absenteismo_aluno (aluno_presenca) desde 2026-07-04 -- antes lia alunos.percentual_presenca, coluna dessincronizada (sem trigger de escrita, atualizar_percentual_presenca() nunca era chamada).';

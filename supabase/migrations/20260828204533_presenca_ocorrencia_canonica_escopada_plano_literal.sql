-- O SQL dinamico usa somente literais escapados por format(%L) (ledger alinhado). Isso obriga
-- o planner a recortar a origem antes dos rankings sem interpolacao insegura.

...
comment on function public.app_coordenacao_feedback_mes(date, uuid, integer, text, integer) is
  'Semáforo do mês pra COORDENAÇÃO, com filtro de unidade, coração e professor (079). Sem coração escolhido a lista é "precisam de olho"; com coração, é o grupo inteiro. Cada faceta ignora o próprio filtro.';

-- Corrige a marca de "aluno novo" na Agenda.
--
-- A versao anterior (20260803141238) usava nr_da_aula = 1, que e "primeira aula
-- DESTE CONTRATO". Como renovacao abre contrato novo, o contador zera e a marca
-- disparava em toda renovacao. Medido em 03/08/2026: 11 alunos marcados, 7 eram
-- RENOVACAO. O caso limpo e o Yuri Gabriel — mesma turma B_Seg_16, mesmo
-- professor, contrato 3500 indo ate a aula 38 em 13/07 e o 4207 recomecando em
-- 1 no dia 03/08, com 12 aulas anteriores no historico dele.
--
-- Sinal correto: o aluno nao tem NENHUMA aula regular anterior. E fato direto,
-- nao depende de alunos.data_matricula estar correta (dado de cadastro, sujeito
-- a divergencia com o Emusys), e trata reingresso naturalmente — quem volta tem
-- aulas antigas, logo nao e novo.
--
-- categoria = 'normal' exclui a experimental de proposito: a Aline fez
-- experimental em 13/07 e se matriculou depois — ela E aluna nova.
--
-- A condicao fica no ON da lateral, nao no WHERE: e isso que a faz disparar so
-- para quem tem nr_da_aula = 1 (12 alunos num dia de 230) em vez de para todos.
-- Custo medido: 95 ms -> 97 ms.

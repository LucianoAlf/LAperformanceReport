-- Camada 0 da conciliacao Emusys:
-- - centraliza escrita em alunos na RPC guardada;
-- - inclui horario_aula e tipo_matricula_id na whitelist;
-- - valor_parcela e derivado por trigger/regra canonica, nao por aprovacao manual antiga.

-- O UNION anterior nao deduplicava: (aula, aluno, true) e (aula, aluno, false) sao linhas
-- distintas, entao todo aluno que tem roster E presenca entrava duas vezes e o universo
-- dobrava (426 contra 214 em CG/15-09). Agrupar e usar bool_or resolve na raiz.
...
as $function$
  with alvo as materialized (
    ...
    select aula_id, aluno_id, bool_or(tem_vinculo) as tem_vinculo
    from (

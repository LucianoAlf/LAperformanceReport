...
-- Corrigir churn_rate para usar base do mês atual (real-time), não mês anterior
-- Antes: usava dados_anterior.alunos_pagantes quando disponível
-- Depois: sempre usa alunos_mes.alunos_pagantes (atual)
...
SELECT u.id AS unidade_id,
    ...
    -- CORRIGIDO: Sempre usar base do mês atual (real-time), não mês anterior
    CASE

-- Gate 8: preserva observacoes auditaveis para pilares ainda nao pontuaveis.
-- O valor observado de presenca nao altera valor_bruto, nota ou publicabilidade
-- antes da vigencia contratual de 03/08/2026.
...
select
  ...
  'health-score-professor-v3-presenca-2'::text as regra_versao,
  case
...
comment on function public.get_professor_presenca_v3_sombra(date, uuid) is
  'Gate 8: presenca pontuavel desde 03/08/2026; observacao mensal anterior permanece auditavel nos detalhes e fora do score.';

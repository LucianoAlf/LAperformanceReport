...
BEGIN
  ...
  IF p_arquivar AND v_lead_id IS NOT NULL THEN
    ...
    VALUES (p_nome, v_lead_id, p_unidade_id::text, p_source_type, v_action,
      json_build_object('source_id', p_source_id, 'telefone', p_telefone, 'canal', p_canal, 'curso', p_curso)::jsonb, NOW());

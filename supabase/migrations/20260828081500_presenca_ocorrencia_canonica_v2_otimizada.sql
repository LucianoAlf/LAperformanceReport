-- Otimiza o read model canonico sem alterar contrato ou precedencia.
-- Evidencias ligadas ao Emusys e evidencias sem ligacao sao separadas para o
-- planejador usar os indices adequados sem incluir data_aula na identidade.
...
comment on view public.vw_presenca_ocorrencia_canonica_v2 is
  'Read model v2.1 regular em sombra, semanticamente preservado, com evidencia ligada e orfa separadas para planejamento indexado. Experimental permanece em contrato proprio.';

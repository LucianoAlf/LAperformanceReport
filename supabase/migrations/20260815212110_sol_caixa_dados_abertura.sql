...
$fn$;
revoke all on function public.sol_caixa_dados_abertura(uuid,date) from public, anon, authenticated;
grant execute on function public.sol_caixa_dados_abertura(uuid,date) to service_role;

-- A carga de uma unidade pode ultrapassar 60s; os jobs sao espacados em 10 minutos.
...
begin
  if not exists (
    ...
    raise notice 'Cron da agenda nao atualizado: secret sync_presenca_edge_token ausente no Vault.';
    return;
  end if;

...
-- Corrigir vw_dashboard_unidade e vw_kpis_gestao_mensal para usar
-- alunos_historico + alunos(inativo/evadido) como fonte de verdade
-- Em vez de evasoes_v2 + fallback dados_mensais

-- ============================================================
-- 1. vw_dashboard_unidade
-- ============================================================

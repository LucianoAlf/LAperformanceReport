-- ============================================================================
-- P09B - Preview read-only de fechamento mensal: formato comercial
...
-- - Ler o resumo comercial em kpis quando a RPC comercial nao expuser totais.
--
-- Nao faz:
...
IS 'P09B preview read-only de fechamento mensal: compara fontes canonicas vivas, dados_mensais e dominios de relatorio sem gravar snapshot.';

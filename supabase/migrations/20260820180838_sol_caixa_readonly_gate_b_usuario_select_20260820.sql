...
-- Ajuste estreito para helper read-only sol_caixa_resumo_do_dia, que depende de public.usuarios via consulta/view interna.
GRANT SELECT ON TABLE public.usuarios TO sol_caixa_readonly;

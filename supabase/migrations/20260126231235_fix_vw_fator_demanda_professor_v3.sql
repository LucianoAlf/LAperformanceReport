...
-- Corrigir view para calcular corretamente por unidade
...
fator_ponderado AS (
    SELECT 
        ...
        ) ORDER BY apc.quantidade_alunos DESC) AS detalhamento_cursos
...
SELECT 
    ...
    fp.unidade_id,
    COALESCE(fp.total_alunos, 0)::INTEGER AS total_alunos,

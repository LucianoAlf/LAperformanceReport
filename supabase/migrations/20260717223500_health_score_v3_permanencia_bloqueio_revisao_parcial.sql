-- Health Score Professor V3 - bloqueio de amostra historica parcialmente revisada.
-- Uma fracao publicavel nao pode representar todo o historico elegivel.
...
select
  ...
  'health-score-professor-v3-permanencia-4'::text as regra_versao,
  case
...
comment on function public.get_professor_permanencia_v3_sombra(date, uuid) is
  'V3 sombra: permanencia acumulada; historico incompleto ou parcialmente revisado nunca vira KPI oficial.';

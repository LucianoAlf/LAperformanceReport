-- Os "as materialized" que eu havia posto bloqueiam o planner de empurrar filtros
-- para dentro das CTEs. Mesma logica como query solta custa 9,6ms; dentro da funcao
-- com materialized, 3.379ms. Removendo para deixar o planner decidir.

-- Gate 8: evita reavaliar a view canonica de identidade para cada linha de
-- roster/presenca durante a materializacao da rede inteira.
...
comment on function public.get_professor_presenca_v3_sombra(date, uuid) is
  'Gate 8: presenca pontuavel desde 03/08/2026; mapa canonico de identidade e avaliado uma vez por chamada.';

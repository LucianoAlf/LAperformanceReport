-- 2026-08-11 — Expande experimental_leads com todos os campos que podem faltar
--
-- O drawer do lead na Chamada precisa mostrar o que falta: telefone, canal,
-- curso de interesse, faixa etária, professor da experimental. Sem esses
-- campos, a equipe não sabe o que completar.

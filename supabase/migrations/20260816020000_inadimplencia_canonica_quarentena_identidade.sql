-- Checkpoint 4: quarantine invoices whose optional identity arrived malformed.
-- The collector preserves the invoice and records the source defect in
-- payload._la_report.validation_issues. This reader exposes that evidence,
-- marks reconciliation incomplete and fails closed instead of charging it.

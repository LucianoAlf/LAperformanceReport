...
-- A linha stale continua em aulas_emusys para auditoria e presenca, mas deve
-- sair do CTE base antes de a Agenda consolidar varias linhas no mesmo cartao.
-- Fonte preservada da funcao em producao (hash f417e49e5a640e266be1536dcfcaa29c); a unica
-- alteracao funcional abaixo e o predicado de exclusao por origem do sync.

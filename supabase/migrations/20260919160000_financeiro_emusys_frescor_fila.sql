...
-- Faturas: sem claims nas horas 05, 09 e 10 UTC. O mutex das RPCs tambem
-- impede concorrencia com recovery/semanal fora dessas janelas.
select cron.schedule('sync-faturas-fila-worker', '* 0-4,6-8,11-23 * * *', $cron$
  select net.http_post(

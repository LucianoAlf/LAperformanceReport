...
// comunidade_wa_participantes. Agora exige usuario ATIVO com perfil admin/unidade, no
// mesmo padrao de enviar-mensagem-admin. Cron (x-sync-token) e service_role seguem.

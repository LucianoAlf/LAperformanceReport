...
- [x] **Step 1: Criar o teste SQL estrutural**

O teste deve exigir a migration `20260715202505_presenca_politica_unidades_conciliacao.sql`, as duas tabelas, a view semantica v1.2, as tres politicas, precedencia de cancelada/justificada, RPCs seguras e ausencia de `UPDATE public.aluno_presenca` fora da RPC de retificacao.

- [x] **Step 2: Rodar e observar RED**

Run: `node --test tests/presencaPoliticaConciliacao.test.mjs`

Expected: FAIL porque a migration ainda nao existe.

- [x] **Step 3: Criar o teste de integracao estatica da UI**
...
**Files:**
- Create: `supabase/migrations/20260715202505_presenca_politica_unidades_conciliacao.sql`
- Test: `tests/presencaPoliticaConciliacao.test.mjs`

- [x] **Step 1: Criar tabelas e politicas de acesso**
...
- [x] **Step 2: Semear as tres decisoes temporais**
...
- [x] **Step 3: Recriar a view semantica compativel**
...
- [x] **Step 4: Criar fila derivada e RPC de leitura**
...
- [x] **Step 5: Criar RPCs de decisao**
...
- [x] **Step 6: Rodar GREEN do backend**
...
- [x] **Step 1: Criar tipos e carregamento**
...
- [x] **Step 2: Construir o contador de alta visibilidade**
...
- [x] **Step 3: Construir a lista agrupada por aula**
...
- [x] **Step 4: Integrar sem acoplar aos atributos cadastrais**
...
- [x] **Step 1: Documentar a excecao atestada**
...
- [x] **Step 2: Rodar todos os testes Node**
...
**Files:**
- Apply: `supabase/migrations/20260715202505_presenca_politica_unidades_conciliacao.sql`

- [x] **Step 1: Confirmar projeto e baseline**

Confirmar ref `ouqwbbermlzqqvtqwlul` e registrar contagens por unidade/classificacao antes da migration.

- [x] **Step 2: Aplicar migration versionada**

Usar Supabase `apply_migration`, nunca SQL DDL avulso.

- [x] **Step 3: Validar invariantes**
...
- [x] **Step 4: Validar consumidores canonicos**
...
- [x] **Step 1: Iniciar app local**

Run: `npm run dev -- --host 127.0.0.1`

Expected: URL local acessivel.

- [x] **Step 2: Testar com sessao autenticada**
...
- [x] **Step 3: Conferir diff e estado do repositorio**

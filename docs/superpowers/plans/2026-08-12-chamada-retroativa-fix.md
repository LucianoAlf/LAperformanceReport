...
- Read, when present: `supabase/migrations/20260812150000_chamada_retroativa_fallback_emusys.sql`
...
**Files:**
- Create: `supabase/migrations/20260812150000_chamada_retroativa_fallback_emusys.sql`

- [ ] **Step 1: Recreate the RPC with the corrected idempotency guard**
...
- [ ] **Step 2: Make the fixture load the correction after the baseline function**
...
- [ ] **Step 1: Run the focused test plus the relevant existing UI/static tests**
...
- [ ] **Step 1: Apply only the reviewed migration to Supabase**

Use the Supabase migration operation with name `chamada_retroativa_fallback_emusys`, then query the remote function definition and migration history to confirm it is present. Do not run a data backfill.

- [ ] **Step 2: Open the deployed Agenda and authenticate**
...
- [ ] **Step 3: Execute the real retroactive workflow**
...
- [ ] **Step 4: Query the exact row after the E2E action**
...
- [ ] **Step 1: Review the diff and migration history locally**

Run:

```powershell
git diff --stat
git diff -- supabase/migrations/20260812150000_chamada_retroativa_fallback_emusys.sql tests/chamadaRetroativaPostgres.test.mjs
...
```powershell
git add docs/superpowers/specs/2026-08-12-chamada-retroativa-design.md docs/superpowers/plans/2026-08-12-chamada-retroativa-fix.md supabase/migrations/20260812150000_chamada_retroativa_fallback_emusys.sql tests/chamadaRetroativaPostgres.test.mjs
git commit -m "fix(chamada): persist retroactive Emusys fallback decision"
```

- [ ] **Step 3: Report exact branch, commit, remote migration, E2E evidence, and worktree status**

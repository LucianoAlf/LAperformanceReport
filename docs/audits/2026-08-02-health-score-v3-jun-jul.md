...
- A carteira era pontuada na revisão anterior. A decisão aprovada é mantê-la como diagnóstico e sinal de carga, com peso efetivo nulo.
...
1. carteira tiver contribuição ou peso efetivo;
...
A leitura anterior confirma que a causa era regra, não falta de professor. A aprovação final será registrada após aplicar as migrations append-only, materializar os recortes de junho/julho e obter `AUDITORIA_APROVADA=true`, sem alterar snapshots fechados.

...
- **RPCs:** `get_kpis_comercial_canonicos_v2`, `get_conciliacao_experimentais_v2`, `get_experimentais_emusys_operacional_v1`, `pode_gerar_relatorio_comercial_v1`, `buscar_anamnese_pendente`. A aplicação do espelho Emusys usa a RPC privada `aplicar_snapshot_experimentais_emusys_v1`, executável somente por `service_role`.

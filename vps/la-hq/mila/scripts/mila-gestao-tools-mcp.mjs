...
const LEITURA = [
  ...
  { name: 'ficha_lead',
    description: 'Tudo sobre UM contato numa chamada: etapa, dias parado, experimentais (feitas/faltou/canceladas), professor, canal, anúncio, calor da conversa (chegou a humano? quantas mensagens?), sinais abertos, o COMBINADO de retomada (`retomada.ele_disse` — a frase da pessoa, quando disse e o desfecho, se ja houve) e o que já foi registrado. Antes de ligar, olhe `retomada`: se a pessoa pediu para ser chamada em janeiro, ligar hoje queima o contato. Busque por telefone OU nome OU lead_id. Se voltar `ambiguo`, PERGUNTE qual — nunca escolha. Só devolve lead da unidade de quem pergunta.',
  ...
  { name: 'pendencias_comerciais',
    description: 'As pendências cadastrais da unidade, com total, amostra e a ação: matrícula DESTE MÊS sem anamnese, matrícula DESTE MÊS fora da comunidade, experimental realizada sem ficha, lead sem canal de origem, lead sem curso de interesse, experimental feita sem desfecho. Use para "tem pendência cadastral?", "quem está sem anamnese?", "quem dos alunos matriculados esse mês ainda não está na comunidade?" — nessa última, aumente `amostra` até caber a lista inteira e responda com os NOMES, não só o total. ⚠️ A comunidade é conferida pela PESSOA: telefone do aluno, whatsapp, telefone do responsável e os contatos da ficha, contra o grupo da unidade. Se a captura do dia falhar, quem não for encontrado NÃO entra na lista — melhor faltar nome do que cobrar quem já está lá. 🔴 ANAMNESE E COMUNIDADE SÃO SÓ DAS MATRÍCULAS DO MÊS CORRENTE — é a meta do comercial e a mesma coorte do relatório e da estrela HUNTER 360. Matrícula de mês anterior sem anamnese existe, mas é de outro dono (Sol/TOM/Lia): NÃO cobre a consultora por ela, não cite esse número. ⚠️ As duas juntas é que fecham a estrela HUNTER 360 — se faltar só comunidade, diga isso, porque é o passo que falta para a estrela. Cada pendência você pode RESOLVER com as tools de registrar_*.',

...
const LEITURA = [
  ...
  { name: 'pendencias_comerciais',
    description: 'As pendências cadastrais da unidade, com total, amostra e a ação: matrícula DESTE MÊS sem anamnese, matrícula DESTE MÊS fora da comunidade, experimental realizada sem ficha, lead sem canal de origem, lead sem curso de interesse, experimental feita sem desfecho. Use para "tem pendência cadastral?", "quem está sem anamnese?". 🔴 ANAMNESE E COMUNIDADE SÃO SÓ DAS MATRÍCULAS DO MÊS CORRENTE — é a meta do comercial e a mesma coorte do relatório e da estrela HUNTER 360. Matrícula de mês anterior sem anamnese existe, mas é de outro dono (Sol/TOM/Lia): NÃO cobre a consultora por ela, não cite esse número. ⚠️ As duas juntas é que fecham a estrela HUNTER 360 — se faltar só comunidade, diga isso, porque é o passo que falta para a estrela. Cada pendência você pode RESOLVER com as tools de registrar_*.',

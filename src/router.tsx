...
const AlunosResponsivo = lazy(() => import('./components/App/Alunos/AlunosResponsivo'));
const BandasPage = lazy(() => import('./components/App/Bandas').then(m => ({ default: m.BandasPage })));
const FaturasAlunosPage = lazy(() => import('./components/App/FaturasAlunos'));
const SucessoClientePage = lazy(() => import('./components/App/SucessoCliente').then(m => ({ default: m.SucessoClientePage })));
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'alunos',
            element: <Suspense fallback={<PageLoader />}><AlunosResponsivo /></Suspense>,
          },
          {
            path: 'bandas',
            element: <Suspense fallback={<PageLoader />}><BandasPage /></Suspense>,
          },
          {
            path: 'faturas',
            element: <Suspense fallback={<PageLoader />}><FaturasAlunosPage /></Suspense>,
          },
          {
            path: 'sucesso-aluno',
            element: <Suspense fallback={<PageLoader />}><SucessoClientePage /></Suspense>,
          },
          {
            path: 'professores',

  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "absolute left-1 h-7 w-7 bg-slate-800 border border-slate-600 rounded-md flex items-center justify-center text-white hover:bg-slate-700 transition-colors",
        button_next: "absolute right-1 h-7 w-7 bg-slate-800 border border-slate-600 rounded-md flex items-center justify-center text-white hover:bg-slate-700 transition-colors",
        weekdays: "flex",

...
export function Professor360Config({ readOnly = false }: Professor360ConfigProps) {
  ...
  }, [bonusMaxProjetos, pontosPorProjeto, config]);
        ...
        <div className="px-6 py-4 border-b border-slate-700/50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Configure os critérios e pontuações</p>
            </div>
          </div>
        </div>
            ...
            {editingCriterio.tipo === 'penalidade' && (
              <>
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-slate-500">
                    Quantidade de ocorrências toleradas antes de perder pontos
                  </p>
                </div>

...
test('retificacao publica o fechamento operacional confirmado pela Fernanda', () => {
...
test('ticket deriva do MRR congelado e do novo denominador, sem forcar 445,38', () => {
...
test('snapshot executivo muda o denominador antes da reconciliacao financeira final', () => {
